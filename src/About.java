...
public void setupElements() {
	...
	constrain(this,new Label("Copyright \u00a91998-2003 Thomas Much",Label.CENTER),0,2,1,1,GridBagConstraints.HORIZONTAL,GridBagConstraints.NORTHWEST,1.0,0.0,0,10,0,10);
